...
<table width="265px">
    <tr>
        <td align='left'>
                ...
                <p><label>Extras: </label><br/><textarea id="input-text" placeholder="Room features" style="height: 40px" required="" name ="room_feat"><?php if(isset($_POST['add'])){echo $_POST['room_feat']; } ?></textarea></p>
